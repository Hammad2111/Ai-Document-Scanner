...
@Composable
fun DeleteDialog(showDialog: Boolean, onDismiss: () -> Unit,context:Activity) {
    if (showDialog) {
        Box(
            modifier = Modifier
                .fillMaxSize()
            ...
            Column(
                ...
                Image(
                    painter = painterResource(id = R.drawable.mydelete), // Replace with your drawable resource ID
