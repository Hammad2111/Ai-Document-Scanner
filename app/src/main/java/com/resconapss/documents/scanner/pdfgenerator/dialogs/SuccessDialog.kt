...
@Composable
fun SuccessDialog(showDialog: Boolean, onDismiss: () -> Unit,context:Activity) {
    if (showDialog) {
        Box(
            modifier = Modifier
                .fillMaxSize()
            ...
            Column(
                ...
                Text(
                    text = "Your folder is successfully completed",
                ...
                Row(
                    ...
                    Box(modifier = Modifier
                        .fillMaxHeight()
                        .weight(1f)) {
                        generalbutton(title = "View File") {

                            val intent=Intent(context,CustomFolderDetailsActivity::class.java)
