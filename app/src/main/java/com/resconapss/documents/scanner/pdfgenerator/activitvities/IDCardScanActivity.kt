...
class IDCardScanActivity : ComponentActivity() {
        ...
        setContent {
            DocumentScannerAITheme {
                Scaffold(modifier = Modifier.fillMaxSize()) {
                    ...
                    CameraPreview()
                  IDCardScannScreen(context = this)
    ...
    companion object{
        ...
        fun navigateToNextScreen(byteArray: ByteArray, context: Activity) {
            val intent = Intent(context, IDCardScanDetailsFirstActivity::class.java).apply {
